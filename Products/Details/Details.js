...
const Details = ({ id }) => {
    ...
    async function addData(name, price, top, bottom, bra, cup, quantity, gender, category, sale, saleprice, id) 
    {
        ...
        if(check == true)
        {
            alert('The provided name already exists in the database, choose a different or slightly altered name.');
        }
        else
        {
                ...
                <View style = {styles.form}>
                    ...
                    <View style = {styles.row}>
                        <View style = {styles.hold}>
                            ...
                            <SelectList
                                boxStyles = {{maxWidth: '80%', minWidth: '80%'}}
