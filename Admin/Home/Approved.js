            ...
            <View style = {styles.container}>
                ...
                <ImageBackground source = {require('../images/cover6.png')} resizeMethod = 'scale'
                    ...
                    <Modal
                        ...
                        <View style = {styles.container}>
                            <Item name = {name} price = {price} top = {top} bottom = {bottom} bra = {bra} cup = {cup} quantity = {quantity} gender = {gender} category = {category} sale = {sale} saleprice = {saleprice} supplier = {supplier} status = {'Approved'} />
