//This is where we show all the products that have been sold, and their quantity as well as price of the items.
...
const Items = ({ route }) => { 
    ...
    useEffect(() => {
        const fetchProducts = async() => {
            const q = query(collection(db, "Orders"), where("supplier", "==", route.params.id), where("status", "==", "Sent"));
        ...
        return (
            <View style = {styles.container}>
                ...
                <View style = {styles.scroll}>
                    ...
                    <Text style = {styles.desc}> There are no items sold yet.</Text>
                </View>
            </View>
        );
    }
